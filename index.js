...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.qdhoivs.mongodb.net/?retryWrites=true&w=majority`;
...
app.listen(port, () => {
  console.log(`car doctore server is running on port ${port}`);
});
